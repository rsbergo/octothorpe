...
{
    // TODO: Replace string with enum of subjects supported
    private Map<String, List<Observer>> registrar = new HashMap<String, List<Observer>>(); // listeners
     ...
     */
    public void unregisterSubject(String subject)
    {
