...
public class MainWindow extends Proxy
{
    ...
    public void updateContentPanel(ContentPanel newContent)
    {
        ...
        createContentPanelLayout(newContent);
    ...
    // Creates the layout of the content panel.
    private void createContentPanelLayout(ContentPanel newContent)
    {
        GroupLayout layoutManager = new GroupLayout(contentPanel);
        layoutManager.setAutoCreateContainerGaps(true);
        layoutManager.setAutoCreateGaps(true);

        layoutManager.setHorizontalGroup(layoutManager.createSequentialGroup().
            addComponent(newContent.getContent(), GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE, Short.MAX_VALUE)
        );
